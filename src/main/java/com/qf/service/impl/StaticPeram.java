...
public class StaticPeram {
    ...
    // 替换成你的AK
    // 你的accessKeyId
    final static String accessKeyId = "LTAIaxgojoiLXqut";
    // 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    final static String accessKeySecret = "m31625wnWHB6YbuK7HsizeDuKvZTWa";
    // 必填:短信签名-可在短信控制台中找到
    final static String SignName = "名宿酒店";
    // 必填:短信模板-可在短信控制台中找到
    final static String TemplateCode = "SMS_172599706";
